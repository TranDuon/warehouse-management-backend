 ...
 * @author azoom
 */
public class SearchAndAddSaleProductView 
            ...
            ViewHasParameterObject<SearchByNameProductViewParameter>
{
     ...
     */
    public SearchAndAddSaleProductView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchAndAddSaleProductView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchAndAddSaleProductView().setVisible(true);
            }
        });
    }
